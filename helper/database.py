...
DB_NAME = "harshilchhaniyara"
DB_URL = "mongodb+srv://harshilchhaniyara:Z3pI8NHKObnyFuOF@cluster0.tfmnczk.mongodb.net/?retryWrites=true&w=majority"
...
def insert(chat_id):
            user_id = int(chat_id)
            user_det = {"_id":user_id,"file_id":None ,"caption":None ,"daily":0 ,"date":0 , "uploadlimit" :9947483648,"used_limit":0,"usertype":"Free","prexdate" : None}
            try:
